        ...
        mFabAddCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!picPath.isEmpty()||!picPath.equals(""))
                {
                    ...
                    String dats = txtEnterCard.getText().toString();
                    if(!(dats.equals(""))||!(dats.equals(" ")))
                        addData(getApplicationContext(), dats);
                    else
                        Snackbar.make(mFabAddCard, "No text entered!", Snackbar.LENGTH_SHORT).show();
                }

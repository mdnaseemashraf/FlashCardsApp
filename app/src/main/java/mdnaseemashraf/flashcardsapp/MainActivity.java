 ...
 * TODO: 1. Memory Buffering
 * TODO: 2. Deck management
 * TODO: 3. Alarm~Notification
 * TODO: 4. Splash Screen
 */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFabMenu.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                PopupMenu popup = new PopupMenu(MainActivity.this, findViewById(R.id.fabMenu));
                popup.getMenuInflater().inflate(R.menu.main, popup.getMenu());

                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        if(item.getTitle().toString().equalsIgnoreCase("Reset stack")) {
                            mSwipeStack.resetStack();
                            Snackbar.make(mFab, R.string.stack_reset, Snackbar.LENGTH_SHORT).show();
                            return true;
                        }
                        else if(item.getTitle().toString().equalsIgnoreCase("Developer")) {

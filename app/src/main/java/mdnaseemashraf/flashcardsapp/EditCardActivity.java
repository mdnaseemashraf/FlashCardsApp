...
public class AddCardActivity extends AppCompatActivity {
    ...
    private File createImageFile() throws IOException {
       ...
       Log.println(Log.ASSERT,"createImageFile()","Initializing");

        // Create an image file name
        String timeStamp = new SimpleDateFormat("yyyyMMdd_HHmmss").format(new java.util.Date());
        Log.println(Log.ASSERT,"createImageFile()","Time Stamp - "+timeStamp);

        String imageFileName = "JPEG_" + timeStamp;
        Log.println(Log.ASSERT,"createImageFile()","File Name - "+imageFileName);

        File storageDir = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES);
        Log.println(Log.ASSERT,"createImageFile()","storageDir - "+storageDir);
        ...
        Log.println(Log.ASSERT,"creatImageFile()", "Final Path - "+mCurrentPhotoPath);
        return image;
    }
